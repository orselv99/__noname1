...
/// [DISABLED FOR TESTING] Returns plain text as bytes instead of encrypted data
pub fn encrypt_content(_user_id: &str, plaintext: &str) -> Result<Vec<u8>, String> {
...
/// [DISABLED FOR TESTING] Returns bytes as plain text string
pub fn decrypt_content(_user_id: &str, encrypted: &[u8]) -> Result<String, String> {
  // [DISABLED FOR TESTING] Return bytes as plain text string
